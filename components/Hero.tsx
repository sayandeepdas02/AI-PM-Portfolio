        ...
        <div className="screen-line-after flex border-x border-edge">
            ...
            <div className="flex flex-1 flex-col">
                ...
                <div className="flex flex-col flex-1">
                    ...
                    <div className="border-t border-edge grid grid-cols-2 sm:grid-cols-4">
                        ...
                        <a
                            ...
                            rel="noopener noreferrer"
                            aria-label="LinkedIn"
                            className="flex items-center gap-3 p-4 pr-2 transition-colors hover:bg-accent2 sm:border-r border-edge"
                        >
                            <div className="relative size-8 shrink-0">
                        ...
                        {/* LeetCode */}
                        <a
                            href="https://leetcode.com/u/dsayandeep02/"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="LeetCode"
                        ...
                        >
                            <div className="relative size-8 shrink-0">
                                <div className="size-8 rounded-lg bg-[#1a1a1a] flex items-center justify-center">
                                    <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true" className="text-[#ffa116]">
                            ...
                            <span className="flex-1 text-sm font-medium">LeetCode</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-muted-foreground shrink-0" aria-hidden="true"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>
                        </a>
